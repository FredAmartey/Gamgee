...
import { IMAGE_MODELS } from "./ModelSelect";
            ...
            <div className="flex flex-col gap-5 border-t border-border bg-card p-6 lg:max-h-[92svh] lg:overflow-y-auto lg:border-l lg:border-t-0">
              ...
              <div>
                ...
                <div className="mt-3.5 flex flex-wrap gap-1.5">
                  ...
                  {gen.params.imageModel &&
                    gen.params.imageModel !== "auto" && (
                      <Chip title="Image model">
                        {IMAGE_MODELS.find(
                          (m) => m.key === gen.params.imageModel,
                        )?.label ?? gen.params.imageModel}
                      </Chip>
                    )}
